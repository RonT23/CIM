'''
    ...
    Description : Simulation script for the given network 1 as defined in the requirements PDF file.
...
##### Don't touch these
    ...
    net.export_structure("../results/net_1_structure.json")
    net.simulate(target_transition_name=target_transition_name, total_transition_activations=total_transition_activations, log_file="../results/net_1_simulation_log.json")
    json_to_txt("../results/net_1_simulation_log.json", "../results/net_1_simulation_log.txt")
    print_txt_to_console("../results/net_1_simulation_log.txt")
    visualize_petri_net("../results/net_1_structure.json", "../results/net_1_simulation_log.json")
